...
export default function AddPatient() {
  ...
  const validateForm = (): boolean => {
    ...
    if (form.phone2 && !/^[\d\s\+-]{8,}$/.test(form.phone2.replace(/\s/g, ''))) {
      errors.phone2 = t.phoneInvalid
    }

    if (form.nationalId && !/^[\d]{10,}$/.test(form.nationalId.replace(/\s/g, ''))) {
          ...
          <div className="form-container">
            <div className="form-grid" style={{
              ...
              <FormSection title={t.basicInfo}>
                ...
                <FormField label={t.phone2} error={validationErrors.phone2}>
                  <input
                    type="tel"
                    name="phone2"
                    value={form.phone2}
